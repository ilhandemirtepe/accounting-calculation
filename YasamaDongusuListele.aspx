...
<body>
    <div class="container">
        <%using (Html.BeginForm("YasamaDongusuListele", "Merkez", FormMethod.Post, new { @name = "formYasamaDongusuListele" }))
          {%>
            ...
            <div class="col-md-12">
                ...
                <div class="panel-warning">
                   ...
                   <%--     <a class="btn btn-warning btn-md" style="color: #000000" href="AnaSayfa">Anasayfaya Git</a>--%>
                           <a class="btn btn-warning btn-md" style="color: #000000" href="AnaSayfa">Anasayfaya Git</a>
                        <%--  <%:Html.ActionLink("İndir", "ExportPDF", "Merkez", new { @class = "btn btn-danger" })%>--%>
                        ...
                        <table style="display:none" id="xx" class="table table-striped table-bordered">
                            <thead>
                                <tr class="success">
