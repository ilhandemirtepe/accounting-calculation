...
<body>
    <div class="container">
        <%using (Html.BeginForm("YasamaDongusuListele3", "Merkez", FormMethod.Post, new { @name = "formYasamaDongusuListele3" }))
          {%>
                                    ...
                                    <div class="col-md-3">
                                        <table class="table table-striped table-bordered">
                                           ...
                                           <tr>
                                                ...
                                                <td>
                                                    <%: Html.TextBoxFor(model => model.Filtreleme.DonguTarih1Filtre, new { Value ="tarih seçiniz", @class = "datefield", Required="" })%></td>
                                            </tr>
                                            <tr>
                                                <td><label class="control-label ">Bitiş Tarihi</label></td>
                                                <td><%: Html.TextBoxFor(model => model.Filtreleme.DonguTarih2Filtre, new { Value ="tarih seçiniz", @class = "datefield",Required="" })%></td>
