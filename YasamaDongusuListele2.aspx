...
<body>
    <div class="container">
        <%using (Html.BeginForm("YasamaDongusuListele2", "Merkez", FormMethod.Post, new { @name = "formYasamaDongusuListele2" }))
          {%>
                                        ...
                                        <table class="table table-striped table-bordered">
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <td></td>
                                                <td>
                                                    <input class="btn btn-danger btn-sm" type="submit" value="Bul" /></td>
